          ...
          <table className="w-full min-w-[2000px]">
            ...
            <thead>
              <tr className="">
                ...
                <th className="bg-pink-200 px-4 py-3 text-center text-xs font-medium text-gray-700 uppercase tracking-wider border-r border-b" colSpan="26">International Publications</th>
              ...
              <tr>
                ...
                <th className="bg-pink-200 px-2 py-2 text-center text-xs font-medium text-gray-700 border-r">Delisted from Scopus</th>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {reportData.map((row, idx) => (
                <tr key={idx} className="hover:bg-gray-50">
                  ...
                  <td className="px-2 py-3 text-sm text-center text-gray-900 border-r">{row.ahci}</td>
              ...
              <tr className="bg-gray-100 font-semibold">
                ...
                <td className="px-2 py-3 text-sm text-center text-gray-900 border-r">{totalRow.ahci}</td>
