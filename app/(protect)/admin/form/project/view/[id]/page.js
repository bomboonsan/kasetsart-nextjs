                ...
                <div className='space-y-4'>
                    <Block>
                        ...
                        <div className="inputGroup">
                            ...
                            <FieldView label="ประเภทโครงการ" value={project.projectType === '0' ? 'โครงการวิจัย' : project.projectType === '1' ? 'โครงการพัฒนาวิชาการประเภทงานวิจัย' : '-'} />
                            <FieldView label="ลักษณะโครงการวิจัย" value={project.projectMode === '0' ? 'โครงการวิจัยเดี่ยว' : project.projectMode === '1' ? 'แผนงานวิจัย หรือชุดโครงการวิจัย' : '-'} />
                            ...
                            <FieldView label="เกี่ยวข้องกับสิ่งแวดล้อมและความยั่งยืนหรือไม่" value={project.isEnvironmentallySustainable === '0' ? 'เกี่ยวข้อง' : project.isEnvironmentallySustainable === '1' ? 'ไม่เกี่ยวข้อง' : '-'} />
                            <FieldView label="ระยะเวลาการทำวิจัย" value={project.durationStart && project.durationEnd ? `${project.durationStart} - ${project.durationEnd}` : '-'} />
                            <FieldView label="หน่วยงานหลักที่รับผิดชอบโครงการวิจัย" value={project.departments?.[0]?.title || '-'} />
