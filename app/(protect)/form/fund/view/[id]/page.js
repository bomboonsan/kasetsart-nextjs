...
export default function FundViewPage() {
  ...
  return (
    <div>
      <Pageheader title="รายละเอียดทุนตำราหรือหนังสือ" />
          ...
          <Block>
            <div className="mb-4 flex justify-end">
              <Button
                variant="default"
                onClick={() =>
                  router.push(`/form/fund/edit/${fund.documentId}`)
                }
              >
                แก้ไข
              </Button>
            ...
            <div className="inputGroup">
              ...
              <FieldView
                label="ลักษณะของผลงานวิชาการที่จะขอรับทุน"
                value={`${fund.fundType == "0" ? "ตำรา" : "หนังสือ"} ${
                  fund.fundTypeText != null ? fund.fundTypeText : ""
                }`}
              />
              <FieldView
                label="คำอธิบายเนื้อหาของตำราหรือหนังสือ"
                value={fund.contentDesc}
              />
              <FieldView
                label="เอกสารทางวิชาการ ตำรา หรือหนังสือ ที่ผ่านมา"
                value={fund.pastPublications}
              />
              <FieldView
              ...
              <FieldView
                ...
                value={fund.targetGroup}
              />
              <FieldView
                label="การแบ่งบทและรายละเอียดในแต่ละบทของตำรา/หนังสือ"
                value={fund.chapterDetails}
              />
              <FieldView label="จำนวนหน้าประมาณ" value={fund.pages} />
              <FieldView
                label="ระยะเวลาที่จะใช้ในการเขียนประมาณ"
                value={fund.period}
              />
              <FieldView
                label="รายชื่อหนังสือและเอกสารอ้างอิง (บรรณานุกรม)"
                value={fund.references}
              />
